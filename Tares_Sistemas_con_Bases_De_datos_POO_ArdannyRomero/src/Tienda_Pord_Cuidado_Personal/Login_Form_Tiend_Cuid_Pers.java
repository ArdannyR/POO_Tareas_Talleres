...
import Tienda_Pord_Cuidado_Personal.DatabaseConnection_Tienda_Pord_Personales;
...
public class Login_Form_Tiend_Cuid_Pers extends JFrame{
    ...
    public Login_Form_Tiend_Cuid_Pers(){
        setTitle("Tienda");
