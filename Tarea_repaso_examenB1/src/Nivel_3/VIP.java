...
public class VIP extends Servicio {
    ...
    public void ver_resumen(){
        ...
        System.out.printf("\nPasajero: %s \nEdad: %d \nClase: %s \nAsientos: %s \nMaletas: %d \nMaletas extras: %b \nServicios adicionales: Televisión, internet y %s", getNombre(), getEdad(), str_clase, this.asientos, this.maletas, this.maletas_extra);
    }
    ...
    public VIP llenar_datos_faltantes(String nombre, int edad, boolean clase, Scanner sc){
        ...
        System.out.print("Clase VIP ya cuenta con television e internet, por favor ingrese 2 servicios mas: "); this.servicios_adicionales = sc.nextLine();
